            ...
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3" onClick={warningNotif}>
                  <Link to={"/pools"} className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-secondery-300 bg-primary-400 dark:bg-darkMode-500 dark:text-white dark:text-opacity-90 md:py-4 md:text-lg md:px-10">
                  View all pools
                  </Link>
                </div>
              </div>
