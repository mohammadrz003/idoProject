...
const ViewAllPools = ({ darkMode, landingContainerWidth, navJustify }) => {
  ...
  return (
    <>
      <div className="relative bg-white dark:bg-darkMode-600">
        ...
        <div className="relative">
          ...
          <header className="relative container mx-auto py-28 z-30">
            <img className="absolute w-6 bottom-3 right-1/4" src={cometImg} alt=""/>
            <img className="absolute w-6 top-3 right-1/3" src={cometImg} alt=""/>
            <img className="absolute w-12 bottom-9 left-1/3" src={cometImg} alt=""/>
            <img className="absolute w-20 top-9 left-16" src={cometImg} alt=""/>
            {/* rocket Img */}
            <img
        ...
        <div className="bg-darkMode-800">
          <div className="relative bottom-10 container mx-auto">
