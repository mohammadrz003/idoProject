              ...
              next generation launchpad
                ...
                <header className="flex flex-col justify-center relative col-span-6">
                    ...
                    <p className="text-gray-600 font-medium text-lg my-8">
                        ...
                        Recusandae nisi ad optio eius maxime ipsum sapiente quidem sit
                        odio ut.
                    </p>
                    <div>
                        <button
                            className="flex content-center bg-secondery-200 text-white leading-none py-3.5 px-5 rounded-md font-semibold">
                            Get started
                            <svg
