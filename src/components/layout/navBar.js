        ...
        <>
            ...
            <Transition appear show={isOpen} as={Fragment}>
              ...
              &#8203;
                        ...
                        >
                            <div
                                className="inline-block border divide-y-2 divide-gray-200 border-gray-700 w-full py-6 max-w-sm my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                ...
                                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                                    <div className="flex items-center justify-between w-full md:w-auto">
                                        ...
                                        <div className="-mr-2 flex items-center md:hidden space-x-4">
                                            ...
                                            <Popover.Button
                                                className="bg-white dark:bg-darkMode-500 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                                    ...
                                    <div className="px-5 pt-4 flex items-center justify-between">
                                        <div>
                                            <img className="h-8 w-auto"
                                                 src={darkMode === "dark" ? logoImgDark : logoImg} alt=""/>
                                        </div>
                                        <div className="-mr-2">
                                            <Popover.Button
                                                className="bg-white dark:bg-darkMode-700 rounded-md p-2 inline-flex items-center justify-center text-gray-400 dark:text-darkMode-100 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
